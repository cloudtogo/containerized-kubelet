...
| Tag | amd64 | arm64 | arm32v7 |
| --- | --- | --- | --- |
|[`v1.20.10-alpine3.13`]()| `24.11MB / 75.90MB`|`22.19MB / 70.68MB`|`21.84MB / 60.11MB`|
|[`v1.20.10-flannel-alpine3.13`]()| `28.75MB / 80.64MB`|`26.41MB / 75.02MB`|`26.11MB / 64.49MB`|
|[`v1.20.10-cni-alpine3.13`]()| `42.01MB / 94.18MB`|`38.45MB / 87.39MB`|`38.27MB / 76.96MB`|
|[`v1.20.10-kubeadm-alpine3.13`]()| `41.70MB / 94.10MB`|`36.94MB / 86.08MB`|`35.85MB / 74.69MB`|
|[`v1.20.10-kubeadm-cni-alpine3.13`]()| `59.60MB / 112.38MB`|`53.20MB / 102.79MB`|`52.29MB / 91.54MB`|
